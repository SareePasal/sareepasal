const item = {
    ...
    description: {
        title: "Premium Heavy Faux Georgette Embellished Lehenga",
        detail: ["Premium Heavy Faux Georgette Embellished With Beautiful Embroidery, Coding , And Sequins Work With Heavy Cancan And Canvas With Double Inner Covering With Flair",
            "With Heavy Cancan And Canvas With Double Inner Covering",
