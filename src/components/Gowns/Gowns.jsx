                ...
                <div className="flex md:item-center md:justify-center md:w-11/12 ">
                    <div class="relative rounded-xl overflow-auto w-11/12">
                        <div class="relative w-full flex md:gap-6 gap-3 snap-x overflow-x-auto pb-14 ">
                            ...
                            <div class="snap-center snap-always shrink-0 md:mx-7 scroll-ms-1 md:scroll-ms-6 shadow-lg rounded-2xl">
                                <Image class="rounded-2xl" src="/Images/Gown/Leranath Fashion/H-2276/H-2276 (5).jpg" alt="1" width={300} height={300} />
                            </div>
                    ...
                    <ul class="flex flex-row justify-center items-center">
                        <li class="mr-4 last:mr-0">
                            <span
                                ...
                                <a href="#pink" class="block w-6 h-6 bg-pink-500 rounded-full"></a>
                            </span>
                        </li>
                        <li class="mr-4 last:mr-0">
                            <span
                                class="block p-1 border-2 border-white hover:border-gray-500 rounded-full transition ease-in duration-300">
                                <a href="#green" class="block w-6 h-6 bg-green-700 rounded-full"></a>
                            </span>
                        </li>
                        <li class="mr-4 last:mr-0">
                            <span
                                class="block p-1 border-2 border-white hover:border-gray-500 rounded-full transition ease-in duration-300">
                                <a href="#red" class="block w-6 h-6 bg-red-700 rounded-full"></a>
                            </span>
                        </li>
                        ...
                        <li class="mr-4 last:mr-0">
                            <span
                                class="block p-1 border-2 border-white hover:border-gray-500 rounded-full transition ease-in duration-300">
                                <a href="#purple" class="block w-6 h-6 bg-purple-900 rounded-full"></a>
                            </span>
                        </li>
                        <li class="mr-4 last:mr-0">
                            <span
                                class="block p-1 rounded-full transition ease-in duration-300">
                                <a href="#grey" class="block w-6 h-6 bg-black rounded-full"></a>
                            </span>
                        </li>
