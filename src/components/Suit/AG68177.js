const item = {
    ...
    description: {
        title: "GEORGETTE KALMKARI PRINT WORK ANARKALI GOWN BOTTOM WITH DUPATTA --- (SOLD OUT)",
        detail: ["Designer georgette kalmkari print work anarkali gown bottom with dupatta red",
            ...
            "ANARKALI INNER :- PURE MICRO CREPE FULL LINING WITH CANVAS PATTA ATTACHED",
            "DUPATTA WORK :- 2.3 METER PURE SOFT FAUX GEORGETTE KALAMKARI PRINT WITH BORDER TRIANGLE LACE WORK",
            "DUPATTA WIDTH :- 28 INCH SHAWL STYLE DUPPTA",
            "ANARKALI LENGTH :- 55 INCH APPROX",
